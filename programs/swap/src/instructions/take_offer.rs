...
use anchor_spl::{
    associated_token:: AssociatedToken, token_interface::{Mint, TokenAccount, TokenInterface, TransferChecked,CloseAccount, close_account, transfer_checked}
};
...
pub fn send_wanted_tokens_to_maker(context: &Context<TakeOffer>) -> Result<()> {
    ...
    transfer_tokens(&context.accounts.taker_token_account_b,
